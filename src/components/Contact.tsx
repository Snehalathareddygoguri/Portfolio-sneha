...
const Contact = () => {
  const socialLinks = [
    {
      name: "GitHub",
      url: "https://github.com/Snehalathareddygoguri",
      icon: Github,
      username: "@Snehalathareddygoguri",
      description: "Check out my code repositories and contributions",
      color: "hover:text-gray-900 dark:hover:text-gray-100"
    },
    {
      name: "LinkedIn", 
      url: "https://www.linkedin.com/in/goguri-snehalathareddy-522a0a271/",
      icon: Linkedin,
      username: "Goguri Snehalathareddy",
      description: "Connect with me professionally",
      color: "hover:text-blue-600"
    },
    {
      name: "Instagram",
      url: "https://instagram.com/snehalatha_reddy_12",
      icon: Instagram,
      username: "@snehalatha_reddy_12",
      description: "Follow my journey and daily updates",
      color: "hover:text-pink-600"
    },
    {
      name: "HackerRank",
      url: "https://www.hackerrank.com/profile/gogurisnehalath2",
      icon: Award,
      username: "gogurisnehalath2",
      description: "View my coding challenges and rankings",
      color: "hover:text-green-600"
    },
    {
      name: "WhatsApp",
      url: "https://wa.me/916304520031",
      icon: MessageCircle,
      username: "+91 6304520031",
  ...
  const contactInfo = [
    {
      icon: Mail,
      label: "Email",
      value: "gogurisnehalathareddy8522@gmail.com",
      href: "mailto:gogurisnehalathareddy8522@gmail.com"
    },
    {
      icon: Phone,
      label: "Phone",
      value: "+91 6304520031",
      href: "tel:+916304520031"
    },
    {
      icon: MapPin,
      label: "Location",
          ...
          >
            ...
            >
              <Card className="p-6 bg-gradient-card border-primary/10">
                ...
                <a href='mailto:gogurisnehalathareddy8522@gmail.com'>
              ...
              <Card className="p-6 bg-gradient-hero text-white border-0 shadow-glow">
                ...
                <div className="flex gap-3">
                  <Button variant="secondary" size="sm" asChild>
                    <a href="https://github.com/Snehalathareddygoguri" target="_blank" rel="noopener noreferrer">
                      <Github className="w-4 h-4 mr-2" />
                      GitHub
                    </a>
                  </Button>
                  <Button variant="outline" size="sm" className="bg-white/10 border-white/30 text-white hover:bg-white/20" asChild>
                    <a href="https://www.linkedin.com/in/goguri-snehalathareddy-522a0a271/" target="_blank" rel="noopener noreferrer">
